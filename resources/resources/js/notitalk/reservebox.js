	...
	var _main = {
			...
			sendDetail : {
				...
				resend : function(json,gubun){
					...
					console.log('param : ' + _IBJson.encode(json));
				...
				search : {
					...
					get : function(START, type) 
					{
						...
						//var param = $.extend({procType:"getKkoLogList", START:START,COUNT:_this.list.vertical_count}, json);
						if(START == 0) _this.list.current_page = 1;
